...
package com.example.android.camera2.integration.cameraxbasic.utils
...
class MediaStoreUtils(private val context: Context) {
    ...
    /** Uri of the MediaStore image collection this app can access (scoped storage aware). */
    ...
    /** Queries the media collection for images sorted by most-recently-added first. */
