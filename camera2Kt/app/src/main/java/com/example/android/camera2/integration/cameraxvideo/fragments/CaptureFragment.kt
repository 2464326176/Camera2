...
package com.example.android.camera2.integration.cameraxvideo.fragments
...
import com.example.android.camera2.integration.databinding.CxvFragmentCaptureBinding
...
import com.example.android.camera2.integration.cameraxvideo.extensions.getAspectRatio
import com.example.android.camera2.integration.cameraxvideo.extensions.getAspectRatioString
import com.example.android.camera2.integration.cameraxvideo.extensions.getNameString
...
class CaptureFragment : Fragment() {
    ...
    // UI with ViewBinding
    private var _captureViewBinding: CxvFragmentCaptureBinding? = null
    ...
    /** Reference to the in-progress recording, or null when not recording. */
    private var currentRecording: Recording? = null
    /** Cached most-recent [VideoRecordEvent] used to drive the recording UI state. */
     ...
     */
    /** One-time fragment initialization: UI setup, capability enumeration, binding use cases. */
     ...
     */
    /** Resets UI and state to idle after a binding failure, allowing the user to retry. */
    ...
    private fun initializeQualitySectionsUI() {
        ...
        captureViewBinding.qualitySelection.apply {
            ...
            adapter = GenericListAdapter(
                selectorStrings,
                itemLayoutId = R.layout.cxv_video_quality_item
    ...
    override fun onCreateView(
        ...
        _captureViewBinding = CxvFragmentCaptureBinding.inflate(inflater, container, false)
