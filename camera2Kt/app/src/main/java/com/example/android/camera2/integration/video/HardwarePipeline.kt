...
class HardwarePipeline(width: Int, height: Int, fps: Int, filterOn: Boolean, transfer: Int,
    ...
    /** Background thread that hosts all GL/EGL rendering work. */
    ...
    /** Handler bound to [renderThread] that performs all rendering operations. */
    ...
    private class ShaderProgram(id: Int,
                                vPositionLoc: Int,
                                texMatrixLoc: Int) {
        /** OpenGL program object id for this shader program. */
        private val id = id
        /** Location of the vertex position attribute in the program. */
        private val vPositionLoc = vPositionLoc
        /** Location of the texture matrix uniform in the program. */
    ...
    private class RenderHandler(looper: Looper, width: Int, height: Int, fps: Int,
        ...
        companion object {
            /** Message: create GL/EGL resources for rendering. */
            val MSG_CREATE_RESOURCES = 0
            /** Message: destroy the EGL window surface. */
            val MSG_DESTROY_WINDOW_SURFACE = 1
            /** Message: begin/restart recording on the encoder surface. */
            val MSG_ACTION_DOWN = 2
            /** Message: clear the on-frame-available listener. */
            val MSG_CLEAR_FRAME_LISTENER = 3
            /** Message: release all resources and shut down. */
            val MSG_CLEANUP = 4
            /** Message: a new camera frame is available for rendering. */
        ...
        /** Transfer function id (e.g. SDR, HLG, PQ) used for color conversion. */
        private val transfer = transfer
        /** Dynamic range profile requested from the camera. */
        ...
        /** Current preview size, updated after layout. */
        ...
        /** OpenGL texture id for the HLG window compositing surface. */
        private var windowTexId: Int = 0
        /** Framebuffer object id for the HLG window compositing surface. */
        private var windowFboId: Int = 0

        /** Whether the device supports native EGL/Android fences for sync. */
