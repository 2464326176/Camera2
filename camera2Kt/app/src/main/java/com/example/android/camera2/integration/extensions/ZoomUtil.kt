...
package com.example.android.camera2.integration.extensions
...
object ZoomUtil {
    ...
    /** Returns the minimum (default) zoom ratio, which is 1.0f. */
    fun minZoom() = 1.0f

    /** Returns the maximum supported digital zoom ratio for the given camera. */
    ...
    /** Computes the sensor crop rectangle for the given [zoomRatio]. */
    ...
    /** Creates a centered crop rectangle of the sensor scaled down by [zoomRatio]. */
    ...
    /** Returns the active sensor array size for the given camera. */
