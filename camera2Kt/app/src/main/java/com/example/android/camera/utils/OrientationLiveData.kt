...
class OrientationLiveData(
    ...
    /** Listens for device orientation changes and posts the relative rotation to this LiveData. */
    ...
    /** Called when the LiveData has active observers; starts listening for orientation changes. */
    override fun onActive() {
        super.onActive()
        listener.enable()
    }

    /** Called when the LiveData loses all active observers; stops listening for orientation changes. */
