...
class QrCodeViewModel(barcode: Barcode) {
    /** Bounding box of the detected QR code, in view coordinates. */
    var boundingRect: Rect = barcode.boundingBox!!
    /** Human-readable content decoded from the QR code. */
    var qrContent: String = ""
    /** Callback invoked on touch events over the QR code (opens a URL for TYPE_URL). */
