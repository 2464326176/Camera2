...
package com.example.android.camera2.integration.cameraxext.repository
    ...
    companion object {
        ...
        fun create(context: Context): ImageCaptureRepository {
            ...
            val mediaDir = context.externalMediaDirs.firstOrNull()?.let {
                File(it, appContext.resources.getString(R.string.integration_app_name)).apply { mkdirs() }
            }
