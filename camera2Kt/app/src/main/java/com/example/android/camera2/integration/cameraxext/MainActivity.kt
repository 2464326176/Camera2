...
package com.example.android.camera2.integration.cameraxext
...
import com.example.android.camera2.integration.cameraxext.adapter.CameraExtensionItem
import com.example.android.camera2.integration.cameraxext.model.CameraState
import com.example.android.camera2.integration.cameraxext.model.CameraUiAction
import com.example.android.camera2.integration.cameraxext.model.CaptureState
import com.example.android.camera2.integration.cameraxext.model.PermissionState
import com.example.android.camera2.integration.cameraxext.repository.ImageCaptureRepository
import com.example.android.camera2.integration.cameraxext.ui.CameraExtensionsScreen
import com.example.android.camera2.integration.cameraxext.ui.doOnLaidOut
import com.example.android.camera2.integration.cameraxext.viewmodel.CameraExtensionsViewModel
import com.example.android.camera2.integration.cameraxext.viewmodel.CameraExtensionsViewModelFactory
import com.example.android.camera2.integration.cameraxext.viewstate.CaptureScreenViewState
import com.example.android.camera2.integration.cameraxext.viewstate.PostCaptureScreenViewState
...
class MainActivity : AppCompatActivity() {
    ...
    /** Uri of the most recent capture result, used to display the post-capture screen. */
    private var captureUri: Uri? = null
    /** Flag set true once post-capture processing has finished. */
    private var progressComplete: Boolean = false

    /** Shows the post-capture screen once both the capture Uri and processing are ready. */
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.cxext_activity_main)
    ...
    /** Closes the post-capture preview and returns to the live camera preview. */
