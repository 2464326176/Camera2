...
class GenericListAdapter<T>(
    ...
    /** Holds the root [view] of a single list item. */
    class GenericListViewHolder(val view: View) : RecyclerView.ViewHolder(view)

    /** Creates a [GenericListViewHolder] using the layout id or the provided view factory. */
    ...
    /** Binds the item at [position] to its view by invoking the [onBind] callback. */
