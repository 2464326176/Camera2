...
import com.example.android.camera2.integration.databinding.CxFragmentGalleryBinding
import com.example.android.camera2.integration.cameraxbasic.utils.MediaStoreFile
import com.example.android.camera2.integration.cameraxbasic.utils.MediaStoreUtils
import com.example.android.camera2.integration.cameraxbasic.utils.padWithDisplayCutout
import com.example.android.camera2.integration.cameraxbasic.utils.showImmersive
...
class GalleryFragment internal constructor() : Fragment() {
    ...
    /** Android ViewBinding */
    private var _fragmentGalleryBinding: CxFragmentGalleryBinding? = null
    ...
    /** In-memory list of photo/video media items shown in this gallery. */
    private var mediaList: MutableList<MediaStoreFile> = mutableListOf()
    /** Completes with true once the gallery has at least one media item (enables actions). */
    ...
    inner class MediaPagerAdapter(fm: FragmentManager,
        ...
        /** Replaces the adapter's media list and refreshes the pager. */
    ...
    override fun onCreateView(
        ...
        _fragmentGalleryBinding = CxFragmentGalleryBinding.inflate(inflater, container, false)
