...
class CenterItemSnapHelper : LinearSnapHelper() {
    ...
    /** Context of the attached RecyclerView. */
    private var context: Context? = null
    /** The RecyclerView this snap helper is currently attached to. */
    private var recyclerView: RecyclerView? = null
    /** Scroller used to compute scrolling distance for fling animations. */
    private var scroller: Scroller? = null
    /** Maximum distance allowed for a single fling, set to half the layout width. */
    ...
    /** Returns the horizontal distance from [targetView]'s center to the RecyclerView center. */
    ...
    /** Finds the child View closest to the RecyclerView center, used as the snap target. */
