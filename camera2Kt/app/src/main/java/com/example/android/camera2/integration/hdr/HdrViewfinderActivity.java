...
import com.example.android.camera2.integration.BuildConfig;
 ...
 * viewfinder.</p>
 *
 * <p>The HDR fusion and the split-screen viewfinder processing is done in plain Java; as is the
 ...
 * fused/composited, a standard YUV->RGB color transform is applied before the the data is drawn
 * onto the preview SurfaceView. The HDR fusion algorithm is very simple, and tends to result in
 * lower-contrast scenes, but has very few artifacts and can run very fast.</p>
 *
 * <p>Data is passed between the subsystems (camera and display) using the
...
public class HdrViewfinderActivity extends AppCompatActivity implements
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.hdr_main, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.info) {
            MessageDialogFragment.newInstance(R.string.camera_error)
    ...
    private void requestCameraPermissions() {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.CAMERA)) {
            ...
            Snackbar.make(rootView, R.string.camera_error, Snackbar
                    .LENGTH_INDEFINITE)
                    .setAction(R.string.camera_error, new View.OnClickListener() {
                        @Override
    ...
    private void configureSurfaces() {
        ...
        mProcessor = new ViewfinderProcessor(outputSize);
        setupProcessor();
    ...
    public String getErrorString(CameraAccessException e) {
        ...
        switch (e.getReason()) {
            ...
            case CameraAccessException.CAMERA_ERROR:
                ...
                break;
            default:
                errorMessage = getString(R.string.camera_error, e.getReason());
                break;
        }
        return errorMessage;
    }
