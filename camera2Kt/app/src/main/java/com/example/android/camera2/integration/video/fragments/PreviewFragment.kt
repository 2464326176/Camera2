...
import com.example.android.camera2.integration.video.CameraActivity
import com.example.android.camera2.integration.video.EncoderWrapper
import com.example.android.camera2.integration.R
import com.example.android.camera2.integration.databinding.VideoFragmentPreviewBinding
...
class PreviewFragment : Fragment() {
    ...
    /** Android ViewBinding */
    private var _fragmentBinding: VideoFragmentPreviewBinding? = null
    ...
    override fun onCreateView(
        ...
        _fragmentBinding = VideoFragmentPreviewBinding.inflate(inflater, container, false)
                    ...
                    if (encoder.shutdown()) {
                        ...
                        if (outputFile.exists()) {
                            ...
                            Handler(Looper.getMainLooper()).post {
                                Toast.makeText(activity, R.string.video_viewer_tips,
