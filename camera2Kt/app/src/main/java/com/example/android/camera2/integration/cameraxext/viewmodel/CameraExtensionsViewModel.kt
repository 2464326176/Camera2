...
package com.example.android.camera2.integration.cameraxext.viewmodel
...
import com.example.android.camera2.integration.cameraxext.model.CameraUiState
...
class CameraExtensionsViewModel(
    ...
    private var imageCapture = ImageCapture.Builder()
        ...
        .build()
    /** Coroutine job that periodically updates the realtime latency estimate. */
    ...
    /** Starts focus and metering at the given [meteringPoint]. */
    ...
    /** Applies pinch-to-zoom by multiplying the current zoom ratio by [scaleFactor]. */
    ...
    /** Maps a lens-facing constant to the corresponding CameraX [CameraSelector]. */
